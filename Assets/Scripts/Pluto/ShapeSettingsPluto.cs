...
[CreateAssetMenu()]
public class ShapeSettingsPluto : ScriptableObject {

    // Planet radius float
    public float planetRadius = 1;

    // noise layers
    public NoiseLayerPluto[] noiseLayersPluto;

    // Noise layer class
    [System.Serializable]
    public class NoiseLayerPluto
    {
        ...
        public NoiseSettingsPluto noiseSettingsPluto;
