...
[CreateAssetMenu()]
public class ShapeSettingsUranus : ScriptableObject {

    // Planet radius float
    public float planetRadius = 1;

    // noise layers
    public NoiseLayerUranus[] noiseLayersUranus;

    // Noise layer class
    [System.Serializable]
    public class NoiseLayerUranus {
        ...
        public NoiseSettingsUranus noiseSettingsUranus;
