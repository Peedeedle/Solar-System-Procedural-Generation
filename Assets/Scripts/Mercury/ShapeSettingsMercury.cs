...
[CreateAssetMenu()]
public class ShapeSettingsMercury : ScriptableObject {

    // Planet radius float
    public float planetRadius = 1;

    // noise layers
    public NoiseLayerMercury[] noiseLayersMercury;

    // Noise layer class
    [System.Serializable]
    public class NoiseLayerMercury {
        ...
        public NoiseSettingsMercury noiseSettingsMercury;
